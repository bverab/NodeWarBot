...
function buildWar(overrides = {}) {
  ...
  return {
    ...
    autoPublishEnabled: Boolean(overrides.autoPublishEnabled),
    scheduledPublishAt: Number.isFinite(overrides.scheduledPublishAt) ? overrides.scheduledPublishAt : null,
    publishError: overrides.publishError || null,
    lastPublishAttemptAt: Number.isFinite(overrides.lastPublishAttemptAt) ? overrides.lastPublishAttemptAt : null,
